...
import com.spindia.sahayatamoney.utils.AppConstants.Companion.MOBILE_REGEX
import com.spindia.sahayatamoney.utils.AppConstants.Companion.PANCARD_REGEX
...
//        sdf.setTimeZone(TimeZone.getTimeZone("GMT-4")); // give a timezone reference for formating (see comment at the bottom
        ...
        //CHECK FOR PAN CARD
        fun checkForPan(editText: EditText): Boolean {
            return Pattern.matches(PANCARD_REGEX, editText.text); }
