package com.spindia.sahayatamoney
...
import com.spindia.sahayatamoney.activities_aeps.AepsOnboardActivity
import com.spindia.sahayatamoney.activities_aeps.AepsTransactionActivity
import com.spindia.sahayatamoney.activities_aeps.CashDepositOtpActivity
import com.spindia.sahayatamoney.activities_bbps.BbpsMainActivity
import com.spindia.sahayatamoney.adapters_recyclerview.SliderAdapter
import com.spindia.sahayatamoney.authentication.LoginActivity
import com.spindia.sahayatamoney.category.CategoryActivity
import com.spindia.sahayatamoney.daybook.DayBookTabActivity
import com.spindia.sahayatamoney.dmt.DmtLoginActivity
import com.spindia.sahayatamoney.dmt.SelectDmtActivity
import com.spindia.sahayatamoney.dmt.SelectDmtModel
import com.spindia.sahayatamoney.fund_services.AddMoneyActivity
import com.spindia.sahayatamoney.fund_services.RequestFundsActivity
import com.spindia.sahayatamoney.fund_services.TransferFundsActivity
import com.spindia.sahayatamoney.microatm.MicroAtmActivity
import com.spindia.sahayatamoney.model.BannerModel
import com.spindia.sahayatamoney.model.UserModel
import com.spindia.sahayatamoney.navigation_activities.SupportActivity
import com.spindia.sahayatamoney.network_calls.AppApiCalls
import com.spindia.sahayatamoney.payout.PayoutActivity
import com.spindia.sahayatamoney.recharge_services.DthRechargeActivity
import com.spindia.sahayatamoney.recharge_services.ElectricityRechargeActivity
import com.spindia.sahayatamoney.recharge_services.LandLineRechargeActivity
import com.spindia.sahayatamoney.recharge_services.MobileRechargeActivity
import com.spindia.sahayatamoney.reports.ReportsActivity
import com.spindia.sahayatamoney.services_and_products.BuyProductsActivity
import com.spindia.sahayatamoney.services_and_products.ProductsAndServicesHistory
import com.spindia.sahayatamoney.user_profile.KycVerificationActivity
import com.spindia.sahayatamoney.user_profile.ProfileActivity
import com.spindia.sahayatamoney.users.MyUsersActivity
import com.spindia.sahayatamoney.utils.*
import com.spindia.sahayatamoney.utils.AppCommonMethods.Companion.logoutOnExpiredDialog
import com.spindia.sahayatamoney.utils.AppConstants.Companion.NEWS
import com.spindia.sahayatamoney.utils.AppConstants.Companion.WALLETBALANCE
                    ...
                    if (service.equals("adharpay_service")) {
                        ...
                        if (cashdeposite_service.equals("inactivate")) {
                            ...
                            if(newaepskyc_status.equals("done")) {
                                ...
                                intent.putExtras(bundle)
                                startActivity(intent)
                            } else if(aeps_kyc_status.equals("KYC Completed") && newaepskyc_status.equals("not-donr")){
                                val intent = Intent(this, KycVerificationActivity::class.java)
                                startActivity(intent)
                            }else {
                                val intent = Intent(this, AepsOnboardActivity::class.java)
